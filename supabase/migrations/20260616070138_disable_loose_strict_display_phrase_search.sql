...
is 'Public active-product search. SECURITY DEFINER is intentionally used to avoid RLS planning overhead; strict non-laptop display phrases bypass loose token and substring matching.';
