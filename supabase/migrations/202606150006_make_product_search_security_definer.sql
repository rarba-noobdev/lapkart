...
is 'Public active-product search. SECURITY DEFINER is intentionally used to avoid RLS planning overhead; the function only returns products with status = active.';
