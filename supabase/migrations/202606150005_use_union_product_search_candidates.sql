...
is 'Indexed product catalog search backed by stored full-text and normalized documents. Candidate IDs are collected through separate index-friendly branches before ranking.';
