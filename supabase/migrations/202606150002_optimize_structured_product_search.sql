...
is 'Indexed product catalog search using Postgres full-text, structured specifications, and normalized part-number matching without broad corpus substring scans.';
