...
<div className="rounded-lg rounded-md rounded-sm rounded-xl" />;
...
export default function BrandHero() {
	return (
		<section className="mx-auto -mt-1 max-w-[1112px]">
			<SectionHead
				action={
				...
				title={
					<>
						<span className="text-heat-100">Firecrawl </span> Brand Assets
					</>
				}
...
export default function MyComponent({ title, variant = 'primary' }: MyComponentProps) {
	return (
		<div className="bg-background-base rounded-8 border border-border-muted">
