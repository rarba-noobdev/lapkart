  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--background-base)] px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-2 font-display text-[88px] leading-none font-medium text-foreground tracking-[-0.03em]">
          404
        </h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "LapKart" },
      {
        name: "description",
        content:
          "LapKart is a marketplace for genuine laptop parts, including RAM, SSDs, batteries, displays, and replacement hardware.",
      },
      { property: "og:title", content: "LapKart" },
      {
        property: "og:description",
        content:
          "Shop genuine laptop parts with compatibility guidance, fast delivery, and secure checkout.",
      },
      ...
      { name: "twitter:title", content: "LapKart" },
      {
        ...
        content:
          "Browse genuine laptop parts, compare pricing, and check out with delivery estimates built for India.",
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/51bd8745-2111-4d21-b5d7-4796ae6a3c2a/id-preview-e0366819--46d13f7e-33f4-4eb6-870b-7b970604b19c.lovable.app-1778983816158.png",
      },
      {
        name: "twitter:image",
        content:
